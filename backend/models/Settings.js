...
const settingsSchema = mongoose.Schema(
  {
    ...
    socialLinks: {
      facebook: { type: String, default: 'https://facebook.com/gentsclothes' },
      instagram: { type: String, default: 'https://instagram.com/gentsclothes' },
      tiktok: { type: String, default: 'https://tiktok.com/@gentsclothes' },
      youtube: { type: String, default: 'https://youtube.com/gentsclothes' }
    },
    heroTitle: {
      type: String,
    ...
    brandStory: {
      title: { type: String, default: 'The Gents Clothes Story' },
      text: { type: String, default: 'Born out of a desire to redefine men\'s fashion in Bangladesh, Gents Clothes bridges the gap between traditional craftsmanship and modern aesthetics.' },
    ...
    newsletter: {
      title: { type: String, default: 'Join the Gents Clothes Club' },
    ...
    staticPages: {
      about: {
        ...
        storyText: { type: String, default: 'Gents Clothes was founded with a singular, uncompromising vision: to redefine luxury menswear in Bangladesh. We believe that true elegance lies in the details—from the meticulous selection of premium fabrics to the flawless precision of our tailoring.' },
      ...
      contact: { type: String, default: '<p><strong>Email:</strong> support@gentsclothes.com</p><p><strong>Phone:</strong> +880 1711 000 000</p><p><strong>Address:</strong> Banani, Dhaka, Bangladesh</p><p style="margin-top:24px">Our customer service team is available Saturday to Thursday, 10 AM to 8 PM.</p>' },
